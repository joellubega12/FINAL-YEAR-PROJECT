...
ALLOWED_HOSTS = ['192.168.236.209', 'localhost', '127.0.0.1']
...
TEMPLATES = [
    {
        ...
        'DIRS': ['voting/templates', 'administrator/templates', 'account/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'joelpaulista256@gmail.com'  # Replace with your Gmail address
EMAIL_HOST_PASSWORD = 'srpgdlijmyywfnyf'  # Use app password, not regular password
DEFAULT_FROM_EMAIL = 'joelpaulista256@gmail.com'  # Same as EMAIL_HOST_USER
